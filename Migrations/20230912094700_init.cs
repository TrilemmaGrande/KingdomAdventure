        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableInStage = table.Column<int>(type: "int", nullable: false),
                    LockedInStage = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RessourceValue = table.Column<double>(type: "float", nullable: false),
                    Icon = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BuildingRessourceProducingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProduceInMinute = table.Column<double>(type: "float", nullable: false),
                    BuildingID = table.Column<int>(type: "int", nullable: false),
                    RessourceID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldiersMax = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerTown", x => x.PlayerTownID);
                    table.ForeignKey(
                        name: "FK_PlayerTown_Player_PlayerID",
                        column: x => x.PlayerID,
                        principalTable: "Player",
                        principalColumn: "PlayerID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TownBuilding_PlayerTown_PlayerTownID",
                        column: x => x.PlayerTownID,
                        principalTable: "PlayerTown",
                        principalColumn: "PlayerTownID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TownRessource_PlayerTown_PlayerTownID",
                        column: x => x.PlayerTownID,
                        principalTable: "PlayerTown",
                        principalColumn: "PlayerTownID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TownSoldier_PlayerTown_PlayerTownID",
                        column: x => x.PlayerTownID,
                        principalTable: "PlayerTown",
                        principalColumn: "PlayerTownID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TownBuildingDeactivatedRessourceProduction",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TownBuildingDeactivatedRessourceProduction", x => x.TownBuildingDeactivatedRessourceProductionID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TownBuilding_PlayerTownID",
                table: "TownBuilding",
                column: "PlayerTownID");

            migrationBuilder.CreateIndex(
                name: "IX_TownBuildingDeactivatedRessourceProduction_BuildingRessourceProducingID",
                table: "TownBuildingDeactivatedRessourceProduction",
                column: "BuildingRessourceProducingID");

            migrationBuilder.CreateIndex(
                name: "IX_TownBuildingDeactivatedRessourceProduction_TownBuildingID",
                table: "TownBuildingDeactivatedRessourceProduction",
                column: "TownBuildingID");

            migrationBuilder.CreateIndex(
                name: "IX_TownRessource_PlayerTownID",
                table: "TownRessource",
                column: "PlayerTownID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TownSoldier_PlayerTownID",
                table: "TownSoldier",
                column: "PlayerTownID");
